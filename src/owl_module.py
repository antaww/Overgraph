...
# %% auto 0
__all__ = ['map_stats', 'df', 'team_evolution', 'get_heroes_stat', 'get_players_stat', 'get_heroes_stat_by_player',
...
def team_evolution(team: str, stat: str) -> pd.DataFrame:
    ...
    result.rename(columns={'start_time': 'Start Time', 'stat_amount': stat, 'match_winner': 'Match Winner', 'winrate': 'Winrate'}, inplace=True)
